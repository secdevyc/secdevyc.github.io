  ...
  $.ajax({
    ...
    .done(
      (data)=>{
          ...
          // takes the 'sprites'(profiles) data and creates <p> and appends to .div4
          ...
          //clears out the input form so it's ready to process another search or quick-pokemon key
          $('#input').val('');
